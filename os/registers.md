...
| Supporter Analytics Assessment (supporter and volunteer data: current state, gaps, process, future state; 7 Sep 2026 read) | https://claude.ai/code/artifact/8a7be06a-72f4-442d-95c2-58b863958227 | Sessions, on request; source at `docs/supporter-analytics-strategy.md`. Point-in-time assessment, not a refreshed dashboard; re-read the numbers before quoting them after September 2026 |
