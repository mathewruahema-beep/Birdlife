...
| `os/birdlife-brain.html` | Source of The BirdLife Brain map (i, Robot style neural view of every skill, ADR, routine, system and artefact, coloured by layer). Reads the repository live through the viewer's GitHub connector at every open; published artifact URL is in the artefact register |
