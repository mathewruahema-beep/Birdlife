...
| Coach | Accountability beyond the gym | Voice on/off, health checks that go amber when due (heart health check, HbA1c, uric acid, bowel kit, prostate conversation, skin, dental), heart-rate zones for the watch, profile, backup. |
